...
function taskA(newCallBack:(text:string)=>void){
...
function taskACallBack(txt:string){
    console.log("Task A: Car Callback",txt);    
    taskC(callCCallBack);   
}
function taskC(newFunction:(text:string)=>void){
...
function callCCallBack(text:string){
    console.log("Task C Callback",text);
    taskD(taskDCallBack);
}
function taskD(newFunction:(text:string)=>void){
...
function taskDCallBack(text:string){
    console.log("Task D: Attend Event",text)
}
//Nested function, complexity increases. Callback Hell
taskA(function (txt:string){
    console.log("Task A: Car Callback",txt);    
    taskC(function (text:string){
        console.log("Task C Callback",text);
        taskD(function (text:string){
            console.log("Task D: Attend Event",text)
        });
    });   
})
